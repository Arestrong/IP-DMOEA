  ...
  */
  class SVMClassifier{
    public:
      ...
      // train the svm
      void train(const Eigen::MatrixXf &X, const vector<int> &y, const vector<double> &weight);
      void train(const Eigen::MatrixXf &X, const Eigen::MatrixXf &y, const vector<double> &weight);
  ...
  public:
	  ...
	  // train the svm
	  void train(const Eigen::MatrixXf &X, const vector<double> &y, const vector<double> &weight);
	  void train(const Eigen::MatrixXf &X, const Eigen::MatrixXf &y, const vector<double> &weight);

	  // test on new data 
	  void test(const Eigen::MatrixXf &X, vector<double> &yhat);
	  ...
	  //parameters
	  void setPara(double C, double epsion, double gamma);
